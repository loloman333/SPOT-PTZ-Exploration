# this is a slightly modified version of Eric Weiser's point_cloud2.py file in the ros_numpy package (MIT License)
# https://github.com/eric-wieser/ros_numpy/blob/master/src/ros_numpy/point_cloud2.py#L133

# it has been adapted to return a 4xN numpy array of points (x, y, z, intensity)
# and removed the rospy dependency of the original
